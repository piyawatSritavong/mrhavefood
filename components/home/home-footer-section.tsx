...
export function HomeFooterSection() {
  return (
    <footer
      ...
      className="flex w-full min-w-0 flex-col justify-center border-t border-[#d9d3d3] bg-white px-3 py-6 min-h-[75dvh] sm:min-h-[calc(100dvh-5rem)] sm:px-4 sm:py-10 lg:px-6"
    >
      <div className="mx-auto grid w-full max-w-7xl gap-6 lg:grid-cols-[1.1fr_0.9fr] lg:items-end">
        ...
        <div className="rounded-2xl bg-(--brand-primary) p-4 text-white shadow-[0_12px_40px_rgba(0,67,124,0.18)]">
          ...
          <p className="mt-1.5 font-display text-xl leading-tight text-white sm:text-lg">
